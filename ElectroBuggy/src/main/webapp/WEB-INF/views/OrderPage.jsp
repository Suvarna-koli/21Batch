...
<body>
<form  action="<c:url value="/payment"/>" modelAttribute="User" method="get">
...
<div class="container">
	...
	<div class="row">        
        <div class="col-md-12">
			...
			<b>Total Prise</b>:<input type="text" name="grandtotal" value="<c:out value="${grandtotal}"/>" readonly></td>
		...
		<div>
		<center>	<a href="ThankPage"><input type="submit" class="btn btn-primary"  value="Place Order"></a></center>
</div>
<div><i><font color="#800000" face="Monotype Corsiva" size="8" >Your Product will place in 4Days....Happy Shopping.....!!!</font></i></div>
